...
-- ----------------------
DELIMITER //
create procedure sp_login(usuario varchar(40), contraseña varchar(40))
begin
select usuario_cliente, contraseña_cliente from tbl_cliente where usuario_cliente = usuario and contraseña_cliente 
= contraseña;
end //
DELIMITER ;

DELIMITER //
create procedure sp_iniciarSesion(u varchar(40), c varchar(40))
begin 
select usuario_cliente, contraseña_cliente from tbl_cliente where usuario_cliente = u and contraseña_cliente = c;
end //
DELIMITER ;

call sp_iniciarSesion('jose', '123');
